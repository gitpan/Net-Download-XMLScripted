# This Makefile is for the Net::Download::XMLScripted::XMLScripted extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Net/Download/XMLScripted/XMLScripted.pm]
#     AUTHOR => q[Singh T. Junior <tsingh@localdomain>]
#     NAME => q[Net::Download::XMLScripted::XMLScripted]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Net/Download/XMLScripted/XMLScripted.pm]
...
AR_STATIC_ARGS = cr
DIRFILESEP = /
NAME = Net::Download::XMLScripted::XMLScripted
NAME_SYM = Net_Download_XMLScripted_XMLScripted
VERSION = 0.1
...
FULLEXT = Net/Download/XMLScripted/XMLScripted
BASEEXT = XMLScripted
PARENT_NAME = Net::Download::XMLScripted
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Net/Download/XMLScripted/XMLScripted.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Net/Download/XMLScripted/XMLScripted.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DIRFILESEP)Config.pm $(PERL_INC)$(DIRFILESEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Net/Download/XMLScripted
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Net/Download/XMLScripted
...
TO_INST_PM = lib/Net/Download/XMLScripted/XMLScripted.pm

PM_TO_BLIB = lib/Net/Download/XMLScripted/XMLScripted.pm \
...
DISTNAME = Net-Download-XMLScripted-XMLScripted
DISTVNAME = Net-Download-XMLScripted-XMLScripted-0.1
...
manifypods : pure_all  \
	lib/Net/Download/XMLScripted/XMLScripted.pm \
	lib/Net/Download/XMLScripted/XMLScripted.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW)\
	  lib/Net/Download/XMLScripted/XMLScripted.pm $(INST_MAN3DIR)/Net::Download::XMLScripted::XMLScripted.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/Net/Download/XMLScripted/XMLScripted.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Net-Download-XMLScripted-XMLScripted' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.1' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Net/Download/XMLScripted/XMLScripted.pm' >> META.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl XML scripted download program</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Singh T. Junior &lt;tsingh@localdomain&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/Net/Download/XMLScripted/XMLScripted.pm blib/lib/Net/Download/XMLScripted/XMLScripted.pm 
	$(NOECHO) $(TOUCH) $@
